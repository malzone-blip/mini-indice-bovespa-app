...
def main():
    ...
    with st.sidebar:
        ...
        - Os dados são obtidos da API Alpha Vantage.
        - Indicadores calculados: EMA12, EMA26, MACD, RSI, Bandas de Bollinger, Volume MA20, Estocástico.
        - Alertas automáticos baseados em MACD, RSI e Bandas.
